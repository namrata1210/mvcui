...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:JOB_PORTAL_DBConnectionString %>" DeleteCommand="DELETE FROM [Applicant_Resumes] WHERE [Id] = @Id" InsertCommand="INSERT INTO [Applicant_Resumes] ([Applicant], [Resume], [Id]) VALUES (@Applicant, @Resume, @Id)" SelectCommand="SELECT [Applicant], [Resume], [Id] FROM [Applicant_Resumes] WHERE (([Id] = @Id) AND ([Applicant] = @Applicant))" UpdateCommand="UPDATE [Applicant_Resumes] SET [Applicant] = @Applicant, [Resume] = @Resume WHERE [Id] = @Id">
    <DeleteParameters>
    ...
    <SelectParameters>
        ...
        <asp:ControlParameter ControlID="Label1" Name="Applicant" PropertyName="Text" Type="Object" />
    </SelectParameters>
    <UpdateParameters>
        <asp:Parameter Name="Applicant" Type="Object" />
        <asp:Parameter Name="Resume" Type="String" />
