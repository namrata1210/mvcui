<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="Home.aspx.cs" Inherits="CareerCloudUI.Main1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MasterContentPlaceHolder" runat="server">
    <div style="float:right; margin-left: 40px;" >
    <asp:Menu ID="Menu1" runat="server"  Font-Bold="true" Font-Size="small"  >
        <Items >
    ...
    <br />
    <div>
        <h4 style="align-content:center;text-align:center;font-size:medium"><b>About Us</b></h4>
        <p>
            ...
            hat we are likely to step out of our ruts and start searching for
